...
- In the example below, quantitative values are rounded to 1 decimal places, while qualitative values percentage are rounded to 0 decimal place.
...
- You can specify the indentation for columns by using a numeric value correspinding the space to indent text. A dedicated function is implemented: `indent_gtsummary_table()`.     
- You can create subtables with different indentation and combine them into a single table using `gtsummary::tbl_stack`.
